...
describe('v1.SchemaServiceClient', () => {
    ...
    describe('createSchema', () => {
        it('invokes createSchema without error', async () => {
            ...
            assert((client.innerApiCalls.createSchema as SinonStub)
    ...
    describe('getSchema', () => {
        it('invokes getSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSchema as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteSchema', () => {
        it('invokes deleteSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteSchema as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('validateSchema', () => {
        it('invokes validateSchema without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.validateSchema as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('validateMessage', () => {
        it('invokes validateMessage without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.validateMessage as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listSchemas', () => {
        it('invokes listSchemas without error', async () => {
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listSchemas as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
