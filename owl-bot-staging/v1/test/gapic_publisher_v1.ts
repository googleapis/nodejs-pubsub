...
describe('v1.PublisherClient', () => {
    ...
    describe('createTopic', () => {
        it('invokes createTopic without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('Topic', ['name']);
    ...
    describe('updateTopic', () => {
        it('invokes updateTopic without error', async () => {
            ...
            request.topic ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateTopicRequest', ['topic', 'name']);
    ...
    describe('publish', () => {
        it('invokes publish without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PublishRequest', ['topic']);
    ...
    describe('getTopic', () => {
        it('invokes getTopic without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetTopicRequest', ['topic']);
            request.topic = defaultValue1;
            const expectedHeaderRequestParams = `topic=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.pubsub.v1.Topic()
    ...
    describe('deleteTopic', () => {
        it('invokes deleteTopic without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteTopicRequest', ['topic']);
            request.topic = defaultValue1;
            const expectedHeaderRequestParams = `topic=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('detachSubscription', () => {
        it('invokes detachSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DetachSubscriptionRequest', ['subscription']);
    ...
    describe('listTopics', () => {
        it('invokes listTopics without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTopicsRequest', ['project']);
    ...
    describe('listTopicSubscriptions', () => {
        it('invokes listTopicSubscriptions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTopicSubscriptionsRequest', ['topic']);
            request.topic = defaultValue1;
    ...
    describe('listTopicSnapshots', () => {
        it('invokes listTopicSnapshots without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListTopicSnapshotsRequest', ['topic']);
            request.topic = defaultValue1;
            const expectedHeaderRequestParams = `topic=${defaultValue1}`;const expectedResponse = [new String(), new String(), new String()];
