...
describe('v1.SubscriberClient', () => {
    ...
    describe('createSubscription', () => {
        it('invokes createSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('Subscription', ['name']);
    ...
    describe('getSubscription', () => {
        it('invokes getSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('GetSubscriptionRequest', ['subscription']);
    ...
    describe('updateSubscription', () => {
        it('invokes updateSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('UpdateSubscriptionRequest', ['subscription', 'name']);
    ...
    describe('deleteSubscription', () => {
        it('invokes deleteSubscription without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('DeleteSubscriptionRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('modifyAckDeadline', () => {
        it('invokes modifyAckDeadline without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ModifyAckDeadlineRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('acknowledge', () => {
        it('invokes acknowledge without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('AcknowledgeRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('pull', () => {
        it('invokes pull without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('PullRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('modifyPushConfig', () => {
        it('invokes modifyPushConfig without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ModifyPushConfigRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.protobuf.Empty()
    ...
    describe('createSnapshot', () => {
        it('invokes createSnapshot without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('CreateSnapshotRequest', ['name']);
            request.name = defaultValue1;
            const expectedHeaderRequestParams = `name=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
              new protos.google.pubsub.v1.Snapshot()
    ...
    describe('updateSnapshot', () => {
        it('invokes updateSnapshot without error', async () => {
            ...
            request.snapshot ??= {};
            const defaultValue1 =
              getTypeDefaultValue('UpdateSnapshotRequest', ['snapshot', 'name']);
    ...
    describe('seek', () => {
        it('invokes seek without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('SeekRequest', ['subscription']);
            request.subscription = defaultValue1;
            const expectedHeaderRequestParams = `subscription=${defaultValue1}`;
            const expectedResponse = generateSampleMessage(
    ...
    describe('listSubscriptions', () => {
        it('invokes listSubscriptions without error', async () => {
            ...
            const defaultValue1 =
              getTypeDefaultValue('ListSubscriptionsRequest', ['project']);
