...
describe('v1.SubscriberClient', () => {
    ...
    describe('createSubscription', () => {
        ...
        it('invokes createSubscription with error', async () => {
            ...
            await assert.rejects(async () => { await client.createSubscription(request); }, expectedError);
            assert((client.innerApiCalls.createSubscription as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getSubscription', () => {
        ...
        it('invokes getSubscription with error', async () => {
            ...
            await assert.rejects(async () => { await client.getSubscription(request); }, expectedError);
            assert((client.innerApiCalls.getSubscription as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSubscription', () => {
        ...
        it('invokes updateSubscription with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateSubscription(request); }, expectedError);
            assert((client.innerApiCalls.updateSubscription as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteSubscription', () => {
        ...
        it('invokes deleteSubscription with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteSubscription(request); }, expectedError);
            assert((client.innerApiCalls.deleteSubscription as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('modifyAckDeadline', () => {
        ...
        it('invokes modifyAckDeadline with error', async () => {
            ...
            await assert.rejects(async () => { await client.modifyAckDeadline(request); }, expectedError);
            assert((client.innerApiCalls.modifyAckDeadline as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('acknowledge', () => {
        ...
        it('invokes acknowledge with error', async () => {
            ...
            await assert.rejects(async () => { await client.acknowledge(request); }, expectedError);
            assert((client.innerApiCalls.acknowledge as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('pull', () => {
        ...
        it('invokes pull with error', async () => {
            ...
            await assert.rejects(async () => { await client.pull(request); }, expectedError);
            assert((client.innerApiCalls.pull as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('modifyPushConfig', () => {
        ...
        it('invokes modifyPushConfig with error', async () => {
            ...
            await assert.rejects(async () => { await client.modifyPushConfig(request); }, expectedError);
            assert((client.innerApiCalls.modifyPushConfig as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getSnapshot', () => {
        ...
        it('invokes getSnapshot with error', async () => {
            ...
            await assert.rejects(async () => { await client.getSnapshot(request); }, expectedError);
            assert((client.innerApiCalls.getSnapshot as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('createSnapshot', () => {
        ...
        it('invokes createSnapshot with error', async () => {
            ...
            await assert.rejects(async () => { await client.createSnapshot(request); }, expectedError);
            assert((client.innerApiCalls.createSnapshot as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateSnapshot', () => {
        ...
        it('invokes updateSnapshot with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateSnapshot(request); }, expectedError);
            assert((client.innerApiCalls.updateSnapshot as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteSnapshot', () => {
        ...
        it('invokes deleteSnapshot with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteSnapshot(request); }, expectedError);
            assert((client.innerApiCalls.deleteSnapshot as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('seek', () => {
        ...
        it('invokes seek with error', async () => {
            ...
            await assert.rejects(async () => { await client.seek(request); }, expectedError);
            assert((client.innerApiCalls.seek as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listSubscriptions', () => {
        ...
        it('invokes listSubscriptions with error', async () => {
            ...
            await assert.rejects(async () => { await client.listSubscriptions(request); }, expectedError);
            assert((client.innerApiCalls.listSubscriptions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listSnapshots', () => {
        ...
        it('invokes listSnapshots with error', async () => {
            ...
            await assert.rejects(async () => { await client.listSnapshots(request); }, expectedError);
            assert((client.innerApiCalls.listSnapshots as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
