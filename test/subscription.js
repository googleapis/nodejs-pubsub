...
describe('Subscription', function() {
  ...
  describe('initialization', function() {
    ...
    it('should inherit the Subscriber class', function() {
      var options = {};

      subscription = new Subscription(PUBSUB, SUB_NAME, options);
    ...
    it('should localize pubsub.Promise', function() {
      var FakePromise = {};
      var pubsub = extend({Promise: FakePromise}, PUBSUB);

      subscription = new Subscription(pubsub, SUB_NAME);
      assert.strictEqual(subscription.Promise, FakePromise);
    });
  ...
  describe('delete', function() {
    beforeEach(function() {
      subscription.close = common.util.noop;
      subscription.removeAllListeners = common.util.noop;
    });
