...
describe('v1.PublisherClient', () => {
    ...
    describe('createTopic', () => {
        ...
        it('invokes createTopic with error', async () => {
            ...
            await assert.rejects(async () => { await client.createTopic(request); }, expectedError);
            assert((client.innerApiCalls.createTopic as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('updateTopic', () => {
        ...
        it('invokes updateTopic with error', async () => {
            ...
            await assert.rejects(async () => { await client.updateTopic(request); }, expectedError);
            assert((client.innerApiCalls.updateTopic as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('publish', () => {
        ...
        it('invokes publish with error', async () => {
            ...
            await assert.rejects(async () => { await client.publish(request); }, expectedError);
            assert((client.innerApiCalls.publish as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('getTopic', () => {
        ...
        it('invokes getTopic with error', async () => {
            ...
            await assert.rejects(async () => { await client.getTopic(request); }, expectedError);
            assert((client.innerApiCalls.getTopic as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('deleteTopic', () => {
        ...
        it('invokes deleteTopic with error', async () => {
            ...
            await assert.rejects(async () => { await client.deleteTopic(request); }, expectedError);
            assert((client.innerApiCalls.deleteTopic as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    });
    ...
    describe('listTopics', () => {
        ...
        it('invokes listTopics with error', async () => {
            ...
            await assert.rejects(async () => { await client.listTopics(request); }, expectedError);
            assert((client.innerApiCalls.listTopics as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listTopicSubscriptions', () => {
        ...
        it('invokes listTopicSubscriptions with error', async () => {
            ...
            await assert.rejects(async () => { await client.listTopicSubscriptions(request); }, expectedError);
            assert((client.innerApiCalls.listTopicSubscriptions as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('uses async iteration with listTopicSubscriptions without error', async () => {
            ...
            const request = generateSampleMessage(new protos.google.pubsub.v1.ListTopicSubscriptionsRequest());
            request.topic = '';
            const expectedHeaderRequestParams = "topic=";const expectedResponse: string[] | undefined = [];
    ...
    describe('listTopicSnapshots', () => {
        ...
        it('invokes listTopicSnapshots with error', async () => {
            ...
            await assert.rejects(async () => { await client.listTopicSnapshots(request); }, expectedError);
            assert((client.innerApiCalls.listTopicSnapshots as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
