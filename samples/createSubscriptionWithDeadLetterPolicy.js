...
function main(
    ...
    async function createSubscriptionWithDeadLetterPolicy() {
        ...
        console.log(`Created subscription ${subscriptionName} with dead letter topic ${deadLetterTopicName}.`)
        console.log('To process dead letter messages, remember to add a subscription to your dead letter topic.')
    }
