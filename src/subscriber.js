...
/*!
 * Subscriber is used to manage inventory and act as a messaging bus for
 * subscriptions. Should not be used directly, but instead extended by
 * Subscriptions.
 *
 * @private
 ...
 * @return {Promise}
 */
Subscriber.prototype.acknowledge_ = function(ackIds) {
  var self = this;
 ...
 * @return {Promise}
 */
Subscriber.prototype.makeAckModAckRequest_ = function(config) {
 ...
 * @return {Promise}
 */
Subscriber.prototype.modifyAckDeadline_ = function(ackIds, deadline) {
  var self = this;
